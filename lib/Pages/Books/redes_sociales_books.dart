...
class RedesSocialesBooks extends StatefulWidget {
  @override
  _RedesSocialesBooksState createState() => _RedesSocialesBooksState();
}
class _RedesSocialesBooksState extends State<RedesSocialesBooks> {
   final String apiUrl =
      'https://www.googleapis.com/books/v1/volumes?q=redes%20sociales';
